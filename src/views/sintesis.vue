...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center
      .col-lg-10.mb-5
        figure
          img(src="@/assets/curso/temas/sintesis.svg", alt="En la síntesis se abordan los temas más relevantes del componente formativo, centrándose en los mecanismos de control del proyecto y en el plan de mejora diseñado para promover un progreso constante en la organización.")
      .col-auto
